...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/my/activities', name: 'MyActivities', component: () => import('@/views/activity/MyActivitiesView.vue'), meta: { requiresAuth: true } },
    { path: '/my/created', redirect: '/my/created/approved' },
    { path: '/my/created/:section(approved|reviewing|rejected)', name: 'MyCreatedActivities', component: () => import('@/views/activity/CreatedActivitiesView.vue'), meta: { requiresAuth: true, roles: ['publisher', 'admin'] } },
    ...
    { path: '/admin/activities', name: 'AdminActivities', component: () => import('@/views/admin/ActivityManagementView.vue'), meta: { requiresAuth: true, roles: ['admin'] } },
    { path: '/admin/review', name: 'AdminReview', component: () => import('@/views/admin/ReviewView.vue'), meta: { requiresAuth: true, roles: ['admin'] } },
    { path: '/admin/publisher-applications', name: 'PublisherApplications', component: () => import('@/views/admin/PublisherApplicationsView.vue'), meta: { requiresAuth: true, roles: ['admin'] } },
    ...
    { path: '/admin/knowledge', name: 'KnowledgeManagement', component: () => import('@/views/admin/KnowledgeManagementView.vue'), meta: { requiresAuth: true, roles: ['admin'] } },
